...
const KEYWORDS: Kw[] = [
  ...
  },
  {
    ...
    intent: "broad",
    covered: "/",
    suggested: "/altersvorsorge-2027",
    relatedPages: [
      "/altersvorsorgedepot",
      "/altersvorsorgedepot-vs-riester",
      "/altersvorsorgedepot-foerderung",
      "/blog/altersvorsorgedepot-2027",
      "/blog/altersvorsorgedepot-beschlossen",
    ],
    serp: ["wiki", "official", "media", "competitor", "video"],
    outline: [
      "Altersvorsorge in Deutschland 2026/2027 — was sich durch die Reform ändert",
      "Die drei Säulen: gesetzliche Rente, betriebliche Vorsorge, private Vorsorge",
      "Neues Altersvorsorgedepot ab 2027 — Förderung, Kosten (Deckel 1,0 %), Auszahlung",
      "Riester-Bestand, Rürup, bAV und ETF-Sparplan im direkten Vergleich",
      "Welche Vorsorge passt zu wem? Entscheidungsbaum nach Alter, Familie, Einkommen",
      "Rechenbeispiele: 50 €, 150 €, 300 € pro Monat bis Rentenbeginn",
      "FAQ + interaktiver Rechner + interner Link zu /altersvorsorgedepot",
    ],
  },
  {
